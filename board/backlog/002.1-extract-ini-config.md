...
- [ ] `src/main/iniConfig.ts` exports `parseIniContent` and `stringifyIniContent`
- [ ] `main.ts` imports from `iniConfig.ts`; no INI logic remains inline
- [ ] `src/__tests__/main/iniConfig.test.ts` covers round-trip for Palworld-style INI snippets
