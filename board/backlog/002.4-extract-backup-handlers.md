...
- [ ] Backup-related IPC lives in `src/main/serverBackup.ts` (or cohesive backup module)
- [ ] `set-backup-location` is either wired from renderer or removed with tests updated
- [ ] Unit tests cover backup IPC success and validation failure paths
