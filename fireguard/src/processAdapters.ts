...
import { parseNameStatus } from "./gitScope";
import type { DiffEntry, FireguardConfig, RunOnceResult } from "./types";
...
/** Run the configured test command (Jest here) once against specific files. */
export function createTestCommandRunner(options: {
  cwd: string;
