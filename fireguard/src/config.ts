...
import type { FireguardConfig, FireguardThresholds } from "./types";
...
export const DEFAULT_CONFIG: FireguardConfig = {
  ...
  exclude: ["**/__mocks__/**", "**/node_modules/**", "fireguard/**"],
  baseRef: "main",
  testCommand: "npx jest --runTestsByPath",
};
...
function applyEnvOverrides(
  ...
  if (env.FIREGUARD_AGENTIC_FLAKINESS_RUNS) {
    next.thresholds.agenticFlakinessRuns = Number(
      env.FIREGUARD_AGENTIC_FLAKINESS_RUNS
    );
  }
